...
public class SortedListTest {
    ...
    public static void main(String[] args) {
        ...
        numbers = new int[rand.nextInt(5) + 1];
        ...
        System.out.println("***** TESTING TOSTRING WITH CHARACTERS *****");
        ...
        try {
            ...
            System.out.println("Did not throw the correct exception. Exception "
        ...
        System.out.println("\tlist1 = " + s3);
        System.out.println("\tlist2 = " + s4);
        ...
        System.out.println("\n\tList.find('o') = " + s3.find('o'));
        System.out.println("---- Should print 22 ----");

        System.out.println("\n\tList.find('a') = " + s3.find('a'));
        System.out.println("---- Should print 0 ----");

        System.out.println("\n\tList.find('y') = " + s3.find('y'));
        System.out.println("---- Should print -1 ----");
    }
}